...
print('Build model...')
model = py_crepe_pca.model(filter_kernels, dense_outputs, maxlen,
...
for e in xrange(nb_epoch):
    ...
    if subset:
        batches = pca_data_helpers.mini_batch_generator(xi[:subset], yi[:subset],
                                                    vocab, vocab_size, check,
                                                    maxlen,
                                                    batch_size=batch_size)
    else:
        batches = pca_data_helpers.mini_batch_generator(xi, yi, vocab, vocab_size,
                                                    check, maxlen,  batch_size=batch_size)

    test_batches = pca_data_helpers.mini_batch_generator(xi_test, yi_test, vocab,
